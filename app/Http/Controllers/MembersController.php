            ...
            $fields = [
              ...
              //open connection
               ...
               if($api_data["status"] == true){
                ...
                return response()->json(['message'=>'Sorry! We could not validate your bank details. Please ensure they are correct. h  '.$request->bank. $result, 'status'=>$api_data["status"]],405);
